...
var login_routes_1 = __webpack_require__(241);
var LoginModule = /** @class */ (function () {
    function LoginModule() {
    }
    LoginModule = __decorate([
        core_1.NgModule({
            imports: [login_routes_1.routing, shared_1.SharedModule],
...
var LoginComponent = /** @class */ (function () {
    function LoginComponent(oAuthService, us, ns) {
        this.oAuthService = oAuthService;
        this.us = us;
        this.ns = ns;
    }
    LoginComponent.prototype.login = function (model) {
        ...
        this.oAuthService.fetchTokenUsingPasswordFlow(model.username, model.password)
            ...
            .catch(function (err) { return _this.ns.error('Error getting token', err); });
    };
...
module.exports = "<div class=\"row justify-content-center\">\n    <div class=\"col-12 col-lg-6\">\n\n        <div class=\"card\">\n            <div class=\"card-header\">\n                Login\n            </div>\n\n\n            <div class=\"card-block container\">\n                <appc-dynamic-form (onSubmit)=\"login($event)\" [controls]=\"controls\" [btnText]=\"'Login'\"></appc-dynamic-form>\n            </div>\n\n        </div>\n\n        <p class=\"text-center font-weight-bold\">\n            OR\n        </p>\n\n        <div class=\"text-center\">\n            <appc-social-login></appc-social-login>\n        </div>\n\n    </div>\n\n</div>";
...
var login_component_1 = __webpack_require__(226);
var routes = [
    { path: '', component: login_component_1.LoginComponent, data: { state: 'login' } }
];
