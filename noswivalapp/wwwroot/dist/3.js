...
var create_routes_1 = __webpack_require__(245);
var create_component_1 = __webpack_require__(229);
var CreateAccountModule = /** @class */ (function () {
    function CreateAccountModule() {
    }
    CreateAccountModule = __decorate([
        core_1.NgModule({
            imports: [create_routes_1.routing, shared_1.SharedModule],
            declarations: [create_component_1.CreateAccountComponent]
        })
    ], CreateAccountModule);
    return CreateAccountModule;
}());
exports.CreateAccountModule = CreateAccountModule;
...
var CreateAccountComponent = /** @class */ (function () {
    function CreateAccountComponent(oAuthService) {
        this.oAuthService = oAuthService;
    }
    ...
    CreateAccountComponent.prototype.create = function (event) {
...
var create_component_1 = __webpack_require__(229);
var routes = [
    { path: '', component: create_component_1.CreateAccountComponent, data: { state: 'login' } }
];
...
module.exports = "<div class=\"row justify-content-center\">\n  <div class=\"col-12 col-lg-6\">\n\n    <div class=\"card\">\n      <div class=\"card-header\">\n        Create account\n      </div>\n\n      <div class=\"card-block container\">\n        <appc-dynamic-form (onSubmit)=\"create($event)\" [controls]=\"controls\" [btnText]=\"'Create'\"></appc-dynamic-form>\n      </div>\n    </div>\n\n  </div>\n\n</div>";
